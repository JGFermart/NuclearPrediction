...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='ccell', help='name of the model type. [cell]')
        ...
        # data define
        parser.add_argument('--A_file', type=str, default='/data/dataset/cell_A', help='training and testing dataset')
        parser.add_argument('--M_file', type=str, default='/data/dataset/cell_M', help='training and testing dataset')
        parser.add_argument('--N_file', type=str, default='/data/dataset/cell_N', help='training and testing dataset')
        ...
        parser.add_argument('--load_size', type=int, default=464, help='scale images to this size')
        parser.add_argument('--fine_size', type=int, default=384, help='then crop to this size')
        ...
        # Transformer define
        parser.add_argument('--netT', type=str, default='vq', help='specify transformer architecture')
