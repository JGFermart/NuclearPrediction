...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--n_iter', type=int, default=200000, help='# of iter with initial learning rate')
        parser.add_argument('--n_iter_decay', type=int, default=200000, help='# of iter to decay learning rate to zero')
        ...
        parser.add_argument('--save_iters_freq', type=int, default=50000, help='frequency of saving checkpoints at the end of epochs')
