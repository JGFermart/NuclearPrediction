...
class StyleDiscriminator(nn.Module):
    def __init__(self, img_size, ndf=32, blur_kernel=[1, 3, 3, 1], use_attn=False):
        ...
        convs = [style_function.ConvLayer(3, channels[int(2**log_size)], 1)]

        in_channel = channels[int(2**log_size)]
        ...
        self.final_linear = nn.Sequential(
            style_function.EqualLinear(channels[4] * img_size * img_size, channels[4], activation='fused_lrelu'),
