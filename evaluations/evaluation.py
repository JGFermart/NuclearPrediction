...
parser.add_argument('--num_test', type=int, default=0, help='how many images to load for testing')
...
if __name__ == '__main__':
    ...
    for i in range(size):
        ...
        name = name.replace("real","fake") #comment this for TFill and pix2pix evaluation
